...
class NotesViewController: UIViewController {
    static let shared = NotesViewController()
    static var notesActive = false
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotesViewController.notesActive = true
    }
    
    override func viewWillDisappear(_ animated: Bool) {
        super.viewWillDisappear(animated)
        notesTracker.setNotes(notesTextView.text)
        NotesViewController.notesActive = false
    }
    ...
    func isNotesActive() -> Bool {
        return NotesViewController.notesActive
    }
